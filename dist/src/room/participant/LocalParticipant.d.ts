...
import { AudioCaptureOptions, CreateLocalTracksOptions, ScreenShareCaptureOptions, TrackPublishOptions, VideoCaptureOptions, VideoCodec } from '../track/options';
...
export default class LocalParticipant extends Participant {
     ...
     */
    publishAdditionalCodecForTrack(track: LocalTrack | MediaStreamTrack, videoCodec: VideoCodec, options?: TrackPublishOptions): Promise<void>;
